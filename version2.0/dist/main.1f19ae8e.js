...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"lib/react-wheel.js":[function(require,module,exports) {
"use strict";
...
function setAttribute(dom, attrs) {
  for (var key in attrs) {
    //事件绑定
    if (/^on/.test(key)) {
      dom[key.toLocaleLowerCase()] = attrs[key]; // 样式
    } else if (key === 'style') {
...
var _reactWheel = _interopRequireDefault(require("./lib/react-wheel"));

var _reactWheelDom = _interopRequireDefault(require("./lib/react-wheel-dom"));
